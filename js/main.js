...
function getEvents(x) {
  ...
  <a href=\""+eiurl+"\"><img width=180 src=\""+eiurl+"\" title=\""+eauth+"\"/></a>\
  <p>"+edesc+"</p>\
  <h5>"+eloca+"</h5>\
  <h6>"+etime+"</h6>\
...
function getPeople(x) {
  ...
  $.get('updates/people-list', function(data){
    ...
    $.each(lines, function(n, elem) {
      ...
      $("#loadPeople")
      .append("<div id=\"member_" + elem + "\"><h4>" + name + "</h4><img src='img/people/" + elem + "'.jpg width=180 /><div><p id=\"bio_"+elem+"\"></p></div></div>");
